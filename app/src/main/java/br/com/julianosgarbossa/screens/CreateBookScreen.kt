...
fun CreateBookScreen(
    ...
    val isValid = formState.value.title.isNotBlank() &&
        formState.value.author.isNotBlank()
    ...
    Column(Modifier.fillMaxSize().padding(16.dp)) {
        OutlinedTextField(
            ...
            label = { Text("Título") },
            isError = formState.value.title.isBlank(),
        ...
        OutlinedTextField(
            ...
            label = { Text("Autor") },
            isError = formState.value.author.isBlank(),
            modifier = Modifier.fillMaxWidth()
        )
        Spacer(Modifier.height(8.dp))
        ...
        Button(onClick = { viewModel.add(onDone) }, enabled = isValid, modifier = Modifier.fillMaxWidth()) {
